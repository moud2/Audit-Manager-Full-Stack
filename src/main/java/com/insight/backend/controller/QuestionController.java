...
public class QuestionController {
     ...
     */
    @Autowired
    public QuestionController(DeleteQuestionService deleteQuestionService, FindQuestionService findQuestionService, FindCategoryService findCategoryService) {
    ...
    public ResponseEntity<List<Question>> getQuestionsByCategory(@PathVariable("categoryID") Long categoryID){
        ...
        if(optionalCategory.isPresent()){
            ...
            List<Question> questions = new ArrayList<>(category.getQuestions());
